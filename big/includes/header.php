...
<div class="wrapper">
<header>
  <h1><a href="index.php"><i class="fa <?=$logo?>"></i>Derek Murphy's Big Page</a></h1>
...
<nav id="cssmenu">
  <ul>
     <li><a href="../index.php"><span><i class="fa fa-fw fa-hourglass"></i> IT162 Portal</span></a></li>
     ...
     <li><a href="sliders.php"><span><i class="fa fa-fw fa-camera-retro"></i> Sliders</span></a></li>
     <li><a href="webcam.php"><span><i class="fa fa-fw fa-eye"></i> Live Streams</span></a></li>
  </ul>
