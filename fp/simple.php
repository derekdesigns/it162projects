...
?>
    ...
    <div>
		<label>
			Phone:<br /><input type="text" name="Phone" placeholder=" Phone (optional)" title="Name is required" tabindex="10" size="44" autofocus />
		</label>
	</div>
	<!-- below change the HTML to your form elements - only 'Name' & 'Email' (above) are significant -->
	<div>	
		<label>
			Comments:<br /><textarea name="Comments" cols="75%" rows="4" placeholder=" Your comments matter!" tabindex="30"></textarea>
		</label>
	</div>
    <div>
